<main id="main" class="main-site">
    ...
    <head>
        <script src="https://kit.fontawesome.com/6e0ba3a655.js" crossorigin="anonymous"></script>
    </head>
    <style>
        .regprice {
            font-weight: 300;
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="product-rating">
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                ...
                                @else
                                    ...
                                    {{-- <i class="fa fa-star color-gray" aria-hidden="true"> --}}
                                @endif
                            @endfor
                        ...
                        {{-- ATTRIBUTES --}}
                        {{-- PUSHES TO THE SLIDER SO IT DOSNT WORK BECAUSE LACK OF SPACE --}}
                                                        ...
                                                        <div class="comment-text">
                                                            <div class="star-rating">
                                                                <span
                                                                    ...
                                                                    <strong
                                                                        class="rating">{{ $orderItem->review->rating }}</strong>out
                                                                    of 5
                                                                </span>
                                                            </div>
                                                            <p class="meta">
                    ...
                    <div class="wrap-show-advance-info-box style-1 box-in-site">
                        ...
                        <div class="wrap-products">
                            <div class="products slide-carousel owl-carousel style-nav-1 equal-container"
                                data-items="5" data-loop="false" data-nav="false" data-dots="false"
