<div>
    ...
    <head>
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/cd-slider.css') }}">
    ...
    <footer id="footer">
        <div class="wrap-footer-content footer-style-1">
                    ...
                    <ul>
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                ...
                                <p class="fc-desc">On Orders Over $99</p>
                            </div>
            ...
            <div class="main-footer-content bg-gainsboro-faded pb-20">

                <div class="container">
                    <div class="footer-logo">
                        <a class="" href="/">

                            <h2 class="xtra-large text-center text-md-left">myshop</h2>
                                ...
                                <div class="item-content">
                                    <div class="wrap-contact-detail">
                                      {{--  <ul>
                                            ...
                                            <li>
                                                <a class="text-muted" href="tel:{{ $setting->phone }}">
                                            ...
                                            <li>
                                                <a class="text-muted" href="mailto:{{ $setting->email }}">
                            ...
                            <div class="row">
                                <div class="wrap-footer-item twin-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                <li class="menu-item"><a href="{{ route('user.profile') }}"
                                                        class="link-term">My
                                                        Account</a></li>
                                                <li class="menu-item"><a href="/shop"
                                                        class="link-term">Brands</a>
                                                </li>
                                ...
                                <div class="wrap-footer-item twin-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                <li class="menu-item"><a href="/contact-us"
                                                        class="link-term">Contact
                                                        Us</a></li>
                                                <li class="menu-item"><a href="#"
                                                ...
                                                <li class="menu-item"><a href="{{ route('user.orders') }}"
                                                        class="link-term">Order
                                                        History</a></li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2022 myshop. All rights reserved</p>
                    </div>
                    <div class="coppy-right-item item-right">
                        <div class="wrap-nav horizontal-nav">
                            <ul>
                                <li class="menu-item"><a href="/about-us" class="link-term">About us</a>
                                </li>
