            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="" method="POST" class="form-horizontal" wire:submit.prevent="updateSlide()">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Sub title" class="form-control input-md"
                                        wire:model="subtitle">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/images/slides') }}/{{ $image }}" width="120"
                                            alt="">
                                    @endif
                                </div>
                            </div>
